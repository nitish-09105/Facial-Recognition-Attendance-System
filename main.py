...
from tkinter.constants import SUNKEN, X
...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'ABES Student Support' ")
...
window.wm_iconbitmap("C:/Users/ANKIT/python/python_GUI/Proycontec-Robots-Robot-documents.ico")
window.configure(background="black")

frame1 = tk.Frame(window, bg="indigo")
frame1.place(relx=0.11, rely=0.17, relwidth=0.39, relheight=0.80)

frame2 = tk.Frame(window, bg="#21abcd")
frame2.place(relx=0.51, rely=0.17, relwidth=0.38, relheight=0.80)

message3 = tk.Label(window, text="Face Recognition Based Attendance System" ,fg="white",bg="#262523" ,width=65 ,height=1,font=('times', 29, ' bold '),)
...
frame4.place(relx=0.36, rely=0.09, relwidth=0.15, relheight=0.07)

datef = tk.Label(frame4, text =day+"-"+mont[month]+"-"+year, fg="orange",bg="#262523",width=75,height=2,font=('times',22,'bold'))
datef.pack(fill='both',expand=1)

clock = tk.Label(frame3,fg="orange",bg="#262523",width=45 ,height=1,font=('times', 22, 'bold'))
